 !(function (n, i, e, a) {
        ...
        n(t).find(".nav-search").length > 0 && n(t).find(".nav-search").find("form").prepend("<span class='nav-search-close-button' tabindex='0'>&#10005;</span>"),
            (r.init = function () {
                (r.settings = n.extend({}, o, s)),
                    ...
                    n(t).find(".megamenu-tabs").length > 0 && O(),
                    n(i).resize(function () {
                        r.initNavigationMode(C()), w(), r.settings.hiddenOnMobile && m();
                    }),
        ...
        (r.showOffcanvas = function () {
            ...
            (r.initNavigationMode = function (i) {
                r.settings.responsive
                    ? (i <= r.settings.mobileBreakpoint && u > r.settings.mobileBreakpoint && (n(t).addClass("navigation-portrait").removeClass("navigation-landscape"), k(), s !== a && r.callback("onPortrait")),
                      i > r.settings.mobileBreakpoint && d <= r.settings.mobileBreakpoint && (n(t).addClass("navigation-landscape").removeClass("navigation-portrait"), y(), g(), r.hideOffcanvas(), s !== a && r.callback("onLandscape")),
                      (u = i),
                      (d = i))
                ...
                $(),
                    ...
                    navigator.userAgent.match(/Mobi/i) || navigator.maxTouchPoints > 0 || "click" == r.settings.submenuTrigger
                        ? n(t)
                              ...
                              .on(l, function (e) {
                                  if (
                                      ...
                                      if ((e.stopPropagation(), e.preventDefault(), "none" == n(this).siblings(".nav-submenu").css("display"))) return r.showSubmenu(n(this).parent("li"), r.settings.effect), w(), !1;
                        ...
                        : n(t)
                              ...
                              .find("li")
                              .on(f, function () {
                                  r.showSubmenu(this, r.settings.effect), w();
                              })
                              .on(c, function () {
	...
	(function (n) {
        "use strict";
        var i = n(window);
        n.fn.navigation && (n("#navigation2").navigation(), n("#always-hidden-nav").navigation({ hidden: !0 })),
            i.on("load", function () {
                n("#preloader").fadeOut("slow", function () {
                    n(this).remove();
                });
